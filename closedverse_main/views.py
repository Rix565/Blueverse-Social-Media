...
def community_list(request):
    ...
    msg_list = ["eat breakfast.", "be sure to drink a lot of water.", "no war, prioritize peace.", "be chill, be calm.", "*insert inspiring sentence*", "this is gonna be a great day for you.", "why not try other not-usally-used features of the website?", "work is hard, but results are great!"]
    msg = choice(msg_list)
...
def help_rules(request):
    return render(request, 'closedverse_main/help/rules.html', {'title': 'Blueverse Rules', 'age': settings.age_allowed})
...
def help_contact(request):
    return render(request, 'closedverse_main/help/contact.html', {'title': "Contact Info", "email": settings.email})
